...
exports.token = function(params, cb) {
	api('POST', 'https://api.weibo.com/oauth2/access_token?client_id=' + params.key + '&client_secret=' + params.secret + '&grant_type=authorization_code&redirect_uri=' + params.redirect + '&code=' + params.code, function(data) {
